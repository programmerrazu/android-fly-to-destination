...
public class Tools {
    ...
    public static void displayImageRound(final Context ctx, final ImageView img, @DrawableRes int drawable) {
        try {
            Glide.with(ctx).asBitmap().load(drawable).apply(centerCropTransform()).into(new BitmapImageViewTarget(img) {
                @Override
    ...
    public static void toggleCustomise(Context context, ActionBarDrawerToggle toggle, String userId ) {
        if (!TextUtils.isEmpty(userId)) {
           ...
           // Bitmap bitmap = Operation.getFacebookProfilePicture(userId);
            ...
            toggle.setHomeAsUpIndicator(R.drawable.ic_verified_user);

        }
    }

    public static SpannableStringBuilder getSpannableStringBuilder(Feed object, String fixedText) {
...
//                    String  h2="Click here for more.";
        ...
        SpannableString spannableString = new SpannableString(tripTitle);
        String url = "https://developer.android.com";
        spannableString.setSpan(new URLSpan(url), 0, tripTitle.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString.setSpan(new ForegroundColorSpan(Color.BLACK), 0, tripTitle.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableString.setSpan(new StyleSpan(Typeface.BOLD), 0, tripTitle.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public static SpannableString getSpannableItalic(Feed object,Context context) {

        String inviteNote = object.getInviteNote();
        SpannableString spannableUserStr = new SpannableString(" "+inviteNote+ " ");
        spannableUserStr.setSpan(new StyleSpan(Typeface.ITALIC), 0, spannableUserStr.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableUserStr.setSpan(new ImageSpan(context, R.drawable.ic_left_quote), 0, 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        spannableUserStr.setSpan(new ImageSpan(context, R.drawable.ic_right_quote), spannableUserStr.length()-1, spannableUserStr.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spannableUserStr;
    }
